...
<body>
    <div class = "registro">
        <form action="procesar_registro"method ="post">
            <div>
                <input style="width:508px;height:50px" type="text" name ="nombre"placeholder = "Nombres">
            </div>
            <div>
                <input class="input2" type="text" name ="apellidos" placeholder = "Apellidos">
            </div>
            <div>
                <nav class="fecha">Fecha de nacimiento: </nav>
                <input class="input5" type="date" name ="fechan" >
            </div>
            <div>
            ...
            <div>
                ...
                <input class="input6" type="radio" name ="masculino"placeholder = "M">
                <label for="">Femenino</label>
                <input class="input7" type="radio" name ="femenino"placeholder = "F">
            </div>
